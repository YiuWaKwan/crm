(function($, window, document) {
    ...
    Paging.prototype = {
        ...
        createDom: function() {
            ...
            content = '<div class="pagger"><div class="pagger-box"><button type="button"  class="turnPage first-page">首页</button>' +
    ...
    $.fn.paging = function(options) {
		_options = {
            initPageNo: options.pageNum || 1, 
            totalPages: options.pageTotal || 1, 
            totalCount: options.totalCount || '', 
            slideSpeed: options.slideSpeed || 600, 
            jump: options.jump || true, 
            callback: options.callback || function() {} 
        };
        return new Paging($(this), _options);
    }
    $.fn.simple_paging = function(pageNum, pageTotal, callback) {
		_options = {
            initPageNo: pageNum || 1,
